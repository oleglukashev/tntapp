...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      API_URL: JSON.stringify('https://api.dashboard.deroohorecagroep.nl/api/v2'),
      MOLLIE_CLIENT_ID: JSON.stringify('app_WURzGppruyyJhdcK6rcr4jrH'),
      MOLLIE_REDIRECT_URI: JSON.stringify('https://api.dashboard.deroohorecagroep.nl/api/v2/auth/mollie'),
