export default {
  ...
  reservation: {
    ...
    prepayment_success: 'Bedankt! Wij hebben uw aanbetaling ontvangen. Reservering geplaatst.',
    prepayment_failed: 'De transactie is mislukt. Probeer het nog eens.',
    amount_satisfied: 'Voldaan bedrag',
    amount_not_satisfied: 'Bedrag niet tevreden!',
    ...
    corona: 'Corona',
    corona_title: 'Bevestig hierbij de volgende vragen:',
    corona_customer_p1: 'Ik heb de afgelopen dagen <b>geen</b> last gehad van <b>niesverkoudheid, hoesten, koorts boven de 38 graden, benauwdheidsklachten</b>',
    corona_customer_p2: 'Ik heb op dit moment <b>geen</b> huisgenoot met koorts en/of benauwdheidsklachten',
    corona_customer_p3: 'Ik heb <b>geen</b> positieve test gehad op corona in de afgelopen 7 dagen',
    corona_customer_p4: 'Ik ben <b>niet</b> in contact geweest met huisgenoten die positief getest zijn op corona de afgelopen 14 dagen',
    corona_customer_p5: 'Ik zit op dit moment <b>niet</b> in thuisisolatie omdat ik met iemand in contact geweest ben met corona',
    corona_customer_confirmation: 'Ik bevestig hierbij dat ik aan al het bovenstaande voldoe',
    corona_p1: 'Gast heeft de afgelopen dagen <b>geen</b> last gehad van niesverkoudheid, hoesten, koorts boven de 38 graden, benauwdheidsklachten',
    corona_p2: 'Gast heeft op dit moment <b>geen</b> huisgenoot met koorts en/of benauwdheidsklachten',
    corona_p3: 'Gast heeft <b>geen</b> positieve test gehad op corona in de afgelopen 7 dagen',
  ...
  settings: {
    ...
    plugins: {
      ...
      prepayment_title: 'Koppeling aanbetalingen vie Mollie',
      prepayment_description: 'TheNextTable heeft de mogelijkheid om direct een aanbetaling te koppelen via Mollie. Hierdoor kan je bijvoorbeeld voorkomen dat er te veel “no show” reserveringen binnen komen. Als u dit aanzet vergeet dan niet een realistisch bedrag aan te geven als aanbetaling. Een te hoog bedrag kan natuurlijk afschrikken voor het aantal reserveringen wat voltooid wordt. Per aanbetaling betaald de gast €1 aan transactiekosten. Van deze kosten ontvangt u als restauranthouder een vast bedrag van €0,21 per aanbetaling.',
      prepayment_accept_title: 'Betalingen via Mollie ontvangen?',
      prepayment_accept_description: 'Dit koppeld bij uw systeem een betaling via Mollie.',
      prepayment_type_title: 'Aanbetaling',
      prepayment_type_description: 'Vast bedrag / per persoon',
      prepayment_fixed: 'Vast bedrag',
      prepayment_per_person: 'Per persoon',
      prepayment_value: 'Bedrag aanbetaling',
      connect_to_mollie: 'Maak verbinding met Mollie',
      remove_connection_to_mollie: 'Verbinding met Mollie verwijderen',
